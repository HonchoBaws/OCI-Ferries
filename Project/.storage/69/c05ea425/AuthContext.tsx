...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        if (email === 'admin@ociferry.com') {
          toast.success('Admin account created! Please check your email to verify, then you can sign in with admin privileges.');
        } else {
  ...
  const signIn = async (email: string, password: string) => {
    try {
      ...
      if (email === 'admin@ociferry.com') {
        toast.success('Welcome Admin! You have full access to manage routes and bookings.');
      } else {
  ...
  const signOut = async () => {
    try {
      ...
      toast.error('Sign out completed (with some issues)');
